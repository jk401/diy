...
- **Layout & Configuration:**
  ...
  - **Passive Intake:** Generous 200 mm alu-flex duct ensuring very low resistance and smooth fresh air intake.
...
| Item | Description / Model | Est. Price (CZK) |
| :--- | :--- | :--- |
| **Cardboard Box** | 7-layer robust heavy-duty box (120 x 80 x 80 cm) | 0 CZK (recycled) |
| **Humidifier Box** | IKEA SAMLA 45l box (57 x 39 cm) | 150 CZK |
| **Fans** | 3 x Arctic P14 (140 mm high static pressure) | 600 CZK |
| **Power Supply** | IKEA SMAHAGEL 3-port USB charger + DC-DC step-up converter with knob | 200 CZK |
| **Hygrostat** | XH-W3005 digital hygrostat | 150 CZK |
| **Ducting & 3D Print** | 125mm & 200mm alu-flex + 3D printed adapter | 200 CZK |
| **Wicks & Hygiene** | NFT Spreader Mat (1m x 40cm) + copper wire + H2O2 | 150 CZK |
| **Total Estimated Cost** | | **approx. 1450 CZK** |
